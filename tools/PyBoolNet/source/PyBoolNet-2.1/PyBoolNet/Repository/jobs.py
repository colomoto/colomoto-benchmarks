...
if __name__=="__main__":
    ...
    for subdir, _, files in os.walk(rootdir):
        for fname in files:
            if fname in ["remy_tumorigenesis.bnet","klamt_tcr.bnet","grieco_mapk.bnet"]: continue
            ...
            if fname.split(".")[1]=="bnet":
                ...
                diagram = PyBoolNet.AttractorBasins.basins_diagram( primes, "asynchronous", attractors, ComputeBorders=False, Silent=False )
